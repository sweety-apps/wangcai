...
public class ViewHelper 
{
	...
	public static Boolean SetTextStr(Activity activity, int nViewId, String strText) {
		TextView textView = (TextView)activity.findViewById(nViewId);
		if (textView == null) {
			return false;
		}
	...
	public static void SetStateViewBkg(View view, Context context, int nNormalImgId, int nDownImgId) {
		StateListDrawable selector = newSelector(context, nNormalImgId, nDownImgId, nNormalImgId, nNormalImgId);
		view.setBackgroundDrawable(selector);
	}
}
